        ...
        <div class="flex">
          <div class="-ml-2 mr-2 flex items-center md:hidden">
            ...
            <button type="button"
              ...
              <HeroIconOutlineMenu v-show='!$store.state.nav.menuMobi' class="block h-6 w-6" />
              <HeroIconOutlineX v-show='$store.state.nav.menuMobi' class="block h-6 w-6" />
            </button>
          </div>
...
<!--              </div>-->
    ...
    <div v-show='$store.state.nav.menuMobi' class="md:hidden" id="mobile-menu">
      ...
      <div class="pt-4 pb-3 border-t border-gray-200">
        <div class="flex items-center px-4 sm:px-6">
          ...
          <div class="ml-3">
            <div class="text-base font-medium text-gray-800">Adipiscing Elit</div>
            <div class="text-sm font-medium text-gray-500">adipiscing@elit.com</div>
          </div>
        ...
        <div class="mt-3 space-y-1">
          <a href="#" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 sm:px-6">
            Mauris porttitor
          </a>
          <a href="#" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 sm:px-6">
            Dui sed
